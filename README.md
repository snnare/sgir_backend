...
*   **Test de Conexión Dinámico:** Endpoints independientes para validar credenciales SSH y de Bases de Datos (Raw Payload) antes de su registro, con soporte para reintentos y detección de listeners.
